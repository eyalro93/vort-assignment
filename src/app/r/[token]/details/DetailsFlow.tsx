      ...
      <Container>
        <div className="flex flex-1 flex-col gap-8 py-8">
          ...
          <div className="flex flex-col gap-5">
            <ConsentPoint
              title="מי רואה את זה"
              body="מגייסות שמחפשות אנשי תקשורת ומדיה דרך Vort, ורק אם הפרופיל שלכם תואם למה שהן מחפשות. קורות החיים לא מתפרסמים באתר ולא נגישים לחיפוש כללי."
            />
            <ConsentPoint
              title="מקום העבודה הנוכחי שלכם"
              body="קורות החיים שלכם לעולם לא מוצגים למקום העבודה שבו ציינתם שאתם נמצאים היום, ואם ציינתם מקומות נוספים להסתרה - גם הם חסומים."
            />
            <ConsentPoint
              title="מה זה אומר שמגייסת פונה אליכם"
              body="מגייסת שמצאה אתכם רשאית ליצור איתכם קשר ישירות. אין בכך התחייבות מצדכם, ואתם יכולים להתעלם או לסרב בכל שלב."
            />
            <ConsentPoint
              title="איך מוחקים הכל"
              body="בסיום התהליך תקבלו קוד מחיקה אישי. הזנה שלו במסך המחיקה מוחקת לצמיתות את קורות החיים, השכר והפרטים שלכם מהמאגר - מיידית, בלי לפנות אלינו."
            />
          </div>
